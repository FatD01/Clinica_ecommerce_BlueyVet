<div
    ...
    {{-- Botón de realizar pedido - Fuera del área de scroll --}}
    <button class="w-full px-4 py-3 bg-[var(--bluey-primary)] hover:bg-[var(--bluey-secondary)] text-white font-semibold rounded-lg shadow-md transition-colors duration-200 mt-4">
        Realizar pedido
    </button>
</div>
<script>
    ...
    async function updateCartFloatingComponent() {
        try {
            ...
            if (cartFloatingElement) {
                ...
                cartFloatingElement.outerHTML = data.html;
