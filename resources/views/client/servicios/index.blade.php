                    ...
                    <div class="bg-white rounded-lg shadow-lg overflow-hidden transition-transform transform hover:scale-105
                        ...
                        <div class="p-6">
                            ...
                            @if ($service->status != 'desactivado')
                                {{-- ¡¡¡CAMBIAR ESTO!!! YA NO ES UN FORMULARIO POST DIRECTO --}}
                                {{-- AHORA ES UN ENLACE (GET) A LA PÁGINA DE CHECKOUT --}}
                                <a href="{{ route('payments.show_checkout_page', ['service' => $service->id]) }}"
                                   class="w-full bg-primary text-white font-bold py-3 px-6 rounded-lg hover:bg-blue-800 transition duration-300 block text-center">
